...
Original file is located at
    https://colab.research.google.com/drive/1PeorxNmQ_Wk4Gqy3uasx7m9cqIPEN38l
...
DRIVE_PATH = 'drive/My Drive/Verifiable-Coherent-NLU/'
...
config_epochs = 5 # change 10 to 5, revised here
...
from transformers import BertTokenizer, RobertaTokenizer, DebertaTokenizer, AlbertTokenizer, T5Tokenizer, GPT2Tokenizer, DistilBertTokenizer, XLNetTokenizer
...
tokenizer = tokenizer_class.from_pretrained(f"{DRIVE_PATH}/art_finetuned/bs_15_lr_5e-5")
...
for bs in batch_sizes:
  for lr in learning_rates:
    ...
    emb = emb_class.from_pretrained(model_name,
                                          config=config,
                                          cache_dir=os.path.join(DRIVE_PATH, 'cache'))
    # config = config_class.from_pretrained(f"{DRIVE_PATH}/art_finetuned/bs_15_lr_5e-5")
    # emb = emb_class.from_pretrained(f"{DRIVE_PATH}/art_finetuned/bs_15_lr_5e-5")
...
# eval_model_dir = "bert-base-uncased_cloze_1_1e-05_4_0.0-0.4-0.4-0.2-0.0_tiered_pipeline_lc_ablate_attributes_states-logits" # re-name with the best model
eval_model_dir = "distilbert-base-uncased_cloze_1_1e-05_1_0.0-0.0-0.0-0.5-0.5_tiered_pipeline_lc_ablate_attributes_states-logits"
